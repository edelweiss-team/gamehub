...
<section class="feature-section spad">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 p-0">
                <div class="feature-item set-bg" data-setbg="${pageContext.request.contextPath}/img/features/2.jpg">
            ...
            <div class="col-lg-3 col-md-6 p-0">
                <div class="feature-item set-bg" data-setbg="${pageContext.request.contextPath}/img/features/3.jpg">
                    <span class="cata new">new</span>
                    <div class="fi-content text-white">
            ...
            <div class="col-lg-3 col-md-6 p-0">
                <div class="feature-item set-bg" data-setbg="${pageContext.request.contextPath}/img/features/4.jpg">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="recent-game-item">
                    <div class="rgi-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/recent-game/1.jpg">
                        <div class="cata new">new</div>
                    </div>
                    <div class="rgi-content">
                        ...
                        <div class="rgi-extra">
                            <div class="rgi-star"><img src="${pageContext.request.contextPath}/img/icons/star.png" alt=""></div>
                            <div class="rgi-heart"><img src="${pageContext.request.contextPath}/img/icons/heart.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="recent-game-item">
                    <div class="rgi-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/recent-game/2.jpg">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="recent-game-item">
                    <div class="rgi-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/recent-game/3.jpg">
...
<section class="review-section spad set-bg" data-setbg="${pageContext.request.contextPath}/img/review-bg.png">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="review-item">
                    <div class="review-cover set-bg" data-setbg="${pageContext.request.contextPath}/img/review/2.jpg">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="review-item">
                    <div class="review-cover set-bg" data-setbg="${pageContext.request.contextPath}/img/review/3.jpg">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="review-item">
                    <div class="review-cover set-bg" data-setbg="${pageContext.request.contextPath}/img/review/4.jpg">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-widget mb-5 mb-md-0">
                    ...
                    <div class="latest-blog">
                        <div class="lb-item">
                            <div class="lb-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/latest-blog/1.jpg"></div>
                        ...
                        <div class="lb-item">
                            <div class="lb-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/latest-blog/2.jpg"></div>
                            <div class="lb-content">
                                <div class="lb-date">June 21, 2018</div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum </p>
                                <a href="#" class="lb-author">By Admin</a>
                        ...
                        <div class="lb-item">
                            <div class="lb-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/latest-blog/3.jpg"></div>
                            <div class="lb-content">
                                <div class="lb-date">June 21, 2018</div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum </p>
                                <a href="#" class="lb-author">By Admin</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-widget">
                    ...
                    <div class="top-comment">
                        ...
                        <div class="tc-item">
                            <div class="tc-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/authors/2.jpg"></div>
                            <div class="tc-content">
                                <p><a href="#">James Smith</a> <span>on</span>  Lorem ipsum dolor sit amet, co</p>
                                <div class="tc-date">June 21, 2018</div>
                            </div>
                        ...
                        <div class="tc-item">
                            <div class="tc-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/authors/3.jpg"></div>
                            <div class="tc-content">
                                <p><a href="#">James Smith</a> <span>on</span>  Lorem ipsum dolor sit amet, co</p>
                                <div class="tc-date">June 21, 2018</div>
                            </div>
                        ...
                        <div class="tc-item">
                            <div class="tc-thumb set-bg" data-setbg="${pageContext.request.contextPath}/img/authors/4.jpg"></div>
                            <div class="tc-content">
                                <p><a href="#">James Smith</a> <span>on</span>  Lorem ipsum dolor sit amet, co</p>
                                <div class="tc-date">June 21, 2018</div>
                            </div>
