...
public class CheckOutLoggedUserExpirationWrong {
    ...
    @Test
    public void CheckOutLoggedUserExpirationWrong() throws Exception {
        ...
        driver.findElement(By.id("cc-expiration")).sendKeys("12/aa");
