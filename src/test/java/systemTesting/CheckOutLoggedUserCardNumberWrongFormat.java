...
public class CheckOutLoggedUserCardNumberWrongFormat {
        ...
        @Test
        public void CheckOutLoggedUserCardNumberWrongFormat() throws Exception {
            ...
            driver.findElement(By.id("cc-number")).sendKeys("491655144a956962");
