...
public class RegistrationFailedUsernameShort {
    ...
    @Test
    public void registrationFailedUsernameShort() throws Exception {
        ...
        driver.findElement(By.xpath("//form[@id='signUpForm']/div[2]")).click();
        ...
        driver.findElement(By.xpath("//form[@id='signUpForm']/div[4]")).click();
        driver.findElement(By.xpath("//form[@id='signUpForm']/div[4]")).click();
        ...
        driver.findElement(By.name("telephone")).sendKeys("3279919265");
