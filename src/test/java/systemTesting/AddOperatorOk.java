...
public class AddOperatorOk {
    ...
    public void setUp() throws Exception {
        ...
        ad.doSave(a);
        User u2 = new User("MyUsername","password", "Name", "Surname", "Address", "City", "IT", "2020-11-16", "Uttprova@libero.it", 'M', "3311211111");
        us.doSave(u2);

    }

    @Test
    public void AddOperatorOk() throws Exception {
