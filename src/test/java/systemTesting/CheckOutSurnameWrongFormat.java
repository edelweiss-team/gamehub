 ...
 * TC_4.1_4
 */
public class CheckOutSurnameWrongFormat {
    ...
    @Test
    public void checkOutSurnameWrongFormat() throws Exception {
        ...
        driver.findElement(By.id("firstName")).sendKeys("Gerardo1");
        driver.findElement(By.id("lastName")).click();
        driver.findElement(By.id("lastName")).clear();
        driver.findElement(By.id("lastName")).sendKeys("Brescia1");
