...
public class ModifyUserDataTelephoneShort {
    ...
    @Test
    public void ModifyUserDataTelephoneShort() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td[5]")).sendKeys("3542");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
