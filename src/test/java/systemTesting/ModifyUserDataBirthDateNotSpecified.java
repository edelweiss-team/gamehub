 ...
 * TC_3a.1_8
 */
public class ModifyUserDataBirthDateNotSpecified {
    ...
    @Test
    public void ModifyUserDataBirthDateNotSpecified() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td[4]")).sendKeys("");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
