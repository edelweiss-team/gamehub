...
public class ModifyUserDataUsernameWrong {
    ...
    @Test
    public void ModifyUserDataUsernameWrong() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td")).sendKeys("MyUsername!");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
