...
public class ModifyUserDataPasswordWrong {
    ...
    @Test
    public void ModifyUserDataPasswordWrong() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("passwordBtn")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='2tr']/td")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='2tr']/td")).clear();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='2tr']/td")).sendKeys("Pa ss");
        Thread.sleep(2000);
        driver.findElement(By.id("passwordBtn")).click();
        Thread.sleep(2000);
    }
