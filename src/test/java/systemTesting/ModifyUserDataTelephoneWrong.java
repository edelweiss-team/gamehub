 ...
 * TC_3a.1_11
 */
public class ModifyUserDataTelephoneWrong {
    ...
    @Test
    public void ModifyUserDataTelephoneWrong() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td[5]")).sendKeys("3542ab746");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
