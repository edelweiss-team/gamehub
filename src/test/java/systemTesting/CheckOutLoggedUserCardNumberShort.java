...
public class CheckOutLoggedUserCardNumberShort {
    ...
    @Test
    public void CheckOutLoggedUserCardNumberShort() throws Exception {
        ...
        driver.findElement(By.id("cc-number")).sendKeys("7623682163");
