...
public class RegistrationFailedDateWrong {
    ...
    @Test
    public void registrationFailedDateWrong() throws Exception {
        ...
        driver.findElement(By.id("birthdate")).sendKeys("non selezionato");
