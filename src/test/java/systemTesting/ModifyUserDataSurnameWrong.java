 ...
 * TC_3a.1_7
 */
public class ModifyUserDataSurnameWrong {
    ...
    @Test
    public void ModifyUserDataSurnameWrong() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td[3]")).sendKeys("Rossi1");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
