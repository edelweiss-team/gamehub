 ...
 * TC_1.1_20
 */
public class RegistrationFailedCountryNotExist {
    ...
    @Test
    public void registrationFailedCountryNotExist() throws Exception {
        ...
        driver.findElement(By.name("country")).clear();
        driver.findElement(By.name("country")).sendKeys("AY");
