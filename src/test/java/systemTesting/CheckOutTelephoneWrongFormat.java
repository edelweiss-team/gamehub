 ...
 * TC_4.1_15
 */
public class CheckOutTelephoneWrongFormat {
    ...
    @Test
    public void checkOutTelephoneWrongFormat() throws Exception {
        ...
        driver.findElement(By.id("telephone")).sendKeys("33abc83993");
