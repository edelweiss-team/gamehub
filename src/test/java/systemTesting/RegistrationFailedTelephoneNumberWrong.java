...
public class RegistrationFailedTelephoneNumberWrong {
    ...
    @Test
    public void registrationFailedTelephoneNumberWrong() throws Exception {
        ...
        driver.findElement(By.name("telephone")).sendKeys("3542ab746");
