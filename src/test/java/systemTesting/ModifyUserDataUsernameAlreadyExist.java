...
public class ModifyUserDataUsernameAlreadyExist {
    ...
    public void setUp() throws Exception {
        ...
        User u2 = new User("usernamegiggi","password", "Name", "Surname", "Address", "City", "IT", "2020-11-16", "Utenteprova23@libero.it", 'M', "3111111112");
        us.doSave(u);
        us.doSave(u2);
    ...
    @Test
    public void ModifyUserDataUsernameAlreadyExist() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td")).clear();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td")).sendKeys("usernamegiggi");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
    ...
    public void tearDown() throws Exception {
        ...
        us.doDeleteFromUsername("usernamegiggi");
