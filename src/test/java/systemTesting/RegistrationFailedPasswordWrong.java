...
public class RegistrationFailedPasswordWrong {
    ...
    @Test
    public void registrationFailedPasswordWrong() throws Exception {
        ...
        driver.findElement(By.name("password")).sendKeys("Passwordw");
        driver.findElement(By.name("repeatPassword")).click();
        driver.findElement(By.name("repeatPassword")).clear();
        driver.findElement(By.name("repeatPassword")).sendKeys("Passwordw");
