...
public class RegistrationFailedSurnameWrong {
    ...
    @Test
    public void registrationFailedSurnameWrong() throws Exception {
        ...
        driver.findElement(By.name("surname")).sendKeys("Rossi1");
