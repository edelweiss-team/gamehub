...
public class ModifyOperatorOk {
    ...
    @Test
    public void ModifyOperatorOk() throws Exception {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//tr[@id='AntonioOperatorRow']/td[2]")).sendKeys("Curriculum : neolaureato");
        Thread.sleep(1000);
        driver.findElement(By.xpath("//tr[@id='AntonioOperatorRow']/td[3]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//tr[@id='AntonioOperatorRow']/td[3]")).clear();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//tr[@id='AntonioOperatorRow']/td[3]")).sendKeys("2020-05-22");
        Thread.sleep(1000);
