 ...
 * TC_1.1_23
 */
public class RegistrationFailedTelephoneNumberShort {
    ...
    @Test
    public void registrationFailedTelephoneNumberShort() throws Exception {
        ...
        driver.findElement(By.name("telephone")).sendKeys("35426");
