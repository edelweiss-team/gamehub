 ...
 * TC_1.1_21
 */
public class RegistrationFailedDateFormatWrong {
    ...
    @Test
    public void registrationFailedDateFormatWrong() throws Exception {
        ...
        driver.findElement(By.id("birthdate")).sendKeys("22-05-1999");
