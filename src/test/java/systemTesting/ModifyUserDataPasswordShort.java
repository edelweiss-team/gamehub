...
public class ModifyUserDataPasswordShort {
    ...
    @Test
    public void ModifyUserDataPasswordShort() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='2tr']/td")).sendKeys("pass");
        Thread.sleep(2000);
        driver.findElement(By.id("passwordBtn")).click();
        Thread.sleep(2000);
    }
