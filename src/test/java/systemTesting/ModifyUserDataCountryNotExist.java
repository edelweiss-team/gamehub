 ...
 * TC_3c.1_12
 */
public class ModifyUserDataCountryNotExist {
    ...
    @Test
    public void ModifyUserDataCountryNotExist() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='2tr']/td[6]")).sendKeys("AY");
        Thread.sleep(2000);
        driver.findElement(By.id("2")).click();
        Thread.sleep(2000);
    }
