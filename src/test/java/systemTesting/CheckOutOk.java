...
public class CheckOutOk{
    ...
    public void CheckOutOk() throws Exception {
        ...
        driver.findElement(By.id("telephone")).sendKeys("3");
        driver.findElement(By.id("telephone")).sendKeys(Keys.DOWN);
        driver.findElement(By.id("telephone")).sendKeys(Keys.DOWN);
        driver.findElement(By.id("telephone")).clear();
        ...
        driver.findElement(By.id("cc-name")).sendKeys("N");
        driver.findElement(By.id("cc-name")).sendKeys(Keys.DOWN);
        driver.findElement(By.id("cc-name")).clear();
