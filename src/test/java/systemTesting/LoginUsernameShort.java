...
public class LoginUsernameShort {
    ...
    @Test
    public void LoginUsernameTooShort() throws Exception {
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("usernameField")).sendKeys("My");
        Thread.sleep(1000);
        driver.findElement(By.id("passwordField")).click();
        Thread.sleep(1000);
        driver.findElement(By.id("passwordField")).clear();
        Thread.sleep(1000);
        driver.findElement(By.id("passwordField")).sendKeys("Provais1");
        Thread.sleep(1000);
