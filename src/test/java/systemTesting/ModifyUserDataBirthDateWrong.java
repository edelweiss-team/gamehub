...
public class ModifyUserDataBirthDateWrong {
    ...
    @Test
    public void ModifyUserDataBirthDateWrong() throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//tr[@id='1tr']/td[4]")).sendKeys("22-05-1999");
        Thread.sleep(2000);
        driver.findElement(By.id("1")).click();
        Thread.sleep(2000);
    }
