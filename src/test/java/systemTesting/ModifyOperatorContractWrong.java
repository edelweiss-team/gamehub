...
public class ModifyOperatorContractWrong {
    ...
    @Test
    public void ModifyOperatorContractWrong() throws Exception {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//tr[@id='AntonioOperatorRow']/td[3]")).sendKeys("22!05!2020");
        Thread.sleep(1000);
